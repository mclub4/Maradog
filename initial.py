...
class Main(QWidget):
    ...
    def gameStart(self):
        ...
        # threadings
        # self.monster = [0,0,0,0,0,0]
        # self.mosnter_info = [0,0,0,0,0,0]
        # for i in range(0, 6):
        #     self.monster[i] = QLabel(self)
        #     self.monster_info[i] = slime.Slime()
        #     self.monster_info[i].channge_image(self.monster[i])
        #
